...
function AnimatedGameObject()
{
        ...
        /**Number*/ frameCount, /**Number*/ fps)
    {
        ...
        this.frameHeight = this.frameWidth;                         //FIJARSE ACA!!!!!!!! muy rusty
    ...
    this.updatePos = function() {
        if (this.posChange) {
            if (this.x < this.limitX) {
                this.x += this.speed * g_GameObjectManager.dt;
                if (this.x > this.limitX) {
                    this.x = this.limitX;
                }
            }
            ...
            if (this.y < this.limitY) {
                this.y += this.speed * g_GameObjectManager.dt;
                if (this.y > this.limitY) {
                    this.y = this.limitY;
                }
            }
            ...
            if (this.y == this.limitY && this.x == this.limitX) {
